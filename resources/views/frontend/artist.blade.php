...
<html class="no-js" lang="en">
   <head>
      ...
      <title>Likhun - Premium Lyrics Selling HTML Template </title>
      <meta name="description" content="Likhun is a Conference and Event HTML5 Template. It’s the best choice for beach, cruise, holiday, honeymoon, sea, summer, tour operator, travel, travel agency, travel company, travel package, travel tour, travel wordpress, trip, vacation and much more.">
                     ...
                     <div class="header-info f-right">
                        <div class="header__top-right">
                           ...
                           <div class="header__sm-links">
                              <a href="faq.html" class="login-btn-sm">লগইন</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
                ...
                <div class="artists-list">
                    <ul class="likhun-box row list-unstyled">
                        <li class="likhun-inner-box text-center col-lg-2 col-md-2 col-sm-6 col-2">

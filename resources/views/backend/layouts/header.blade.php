      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text align-items-center">
            ...
            <a href="{{ route('frontend.index') }}" class="text-muted" target="_blank">&nbsp; {{app_name()}}</a>
          </div>
        </div>
      </div>
    </form>
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="flag-icon flag-icon-us mt-1" title="us"></i>&nbsp; {{strtoupper(App::getLocale())}}
          </a>
          <div class="dropdown-menu" aria-labelledby="languageDropdown">
            @foreach(config('app.available_locales') as $locale => $title)
            <a href="{{route("language.switch", $locale)}}" class="dropdown-item py-2"><i class="flag-icon flag-icon-us" title="us" id="us"></i> <span class="ml-1"> {{ $title }} </span></a>
            @endforeach
          </div>
      </li>
